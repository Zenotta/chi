...
var SvgIcon$1 = withStyles(styles$y, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var Paper$1 = withStyles(styles$x, {
  name: 'MuiPaper'
})(Paper);
...
var TouchRipple$1 = withStyles(styles$w, {
  flip: false,
  name: 'MuiTouchRipple'
...
var ButtonBase$1 = withStyles(styles$v, {
  name: 'MuiButtonBase'
})(ButtonBase);
...
var MUIButton = withStyles(styles$u, {
  name: 'MuiButton'
})(Button$1);
...
var Modal = /*#__PURE__*/React__namespace.forwardRef(function Modal(inProps, ref) {
  ...
  var inlineStyle = styles$s(theme || {
    zIndex: zIndex
  });
  var childProps = {};
...
var TextareaAutosize = /*#__PURE__*/React__namespace.forwardRef(function TextareaAutosize(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("textarea", _extends({
    ...
    ref: shadowRef,
    tabIndex: -1,
    style: _extends({}, styles$r.shadow, style)
  }));
});
...
var InputBase$1 = withStyles(styles$q, {
  name: 'MuiInputBase'
})(InputBase);
...
var InputLabel$1 = withStyles(styles$j, {
  name: 'MuiInputLabel'
})(InputLabel);
...
var Menu$1 = withStyles(styles$g, {
  name: 'MuiMenu'
})(Menu);
...
var MUITable = withStyles(styles$b, {
  name: 'MuiTable'
})(Table$1);
...
var TableBody$1 = withStyles(styles$a, {
  name: 'MuiTableBody'
})(TableBody);
...
var TableContainer$1 = withStyles(styles$8, {
...
var TableHead$1 = withStyles(styles$7, {
  name: 'MuiTableHead'
})(TableHead);
...
var TableRow$1 = withStyles(styles$6, {
  name: 'MuiTableRow'
})(TableRow);
...
var TableSortLabel$1 = withStyles(styles$5, {
...
var Loading = function (props) {
    return (jsxRuntime.jsxs("div", __assign({ className: styles$2.loadingContainer, role: "status" }, { children: [jsxRuntime.jsx("svg", __assign({ className: styles$2.loadingSvg, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid" }, { children: jsxRuntime.jsx("circle", __assign({ cx: "50", cy: "50", fill: "none", stroke: props.colour ? props.colour : "#fff", strokeWidth: "10", r: "35", strokeDasharray: "164.93361431346415 56.97787143782138", transform: "rotate(102.756 50 50)" }, { children: jsxRuntime.jsx("animateTransform", { attributeName: "transform", type: "rotate", repeatCount: "indefinite", dur: "1s", values: "0 50 50;360 50 50", keyTimes: "0;1" }, void 0) }), void 0) }), void 0),
            jsxRuntime.jsx("span", __assign({ className: styles$2.loadingScreenreader }, { children: "Loading..." }), void 0)] }), void 0));
};
...
var Button = function (props) {
    ...
    return (jsxRuntime.jsxs(MUIButton, __assign({ classes: {
            root: mainClass().root,
            contained: styles$3.buttonContained
        } }, props, { children: [props.loading &&
                jsxRuntime.jsx("span", __assign({ className: styles$3.loadingContainer }, { children: jsxRuntime.jsx(Loading, { colour: loadingColour }, void 0) }), void 0), props.children] }), void 0));
};
...
var Table = function (props) {
    ...
    return (jsxRuntime.jsx(Paper$1, { children: jsxRuntime.jsx(TableContainer$1, { children: jsxRuntime.jsxs(MUITable, __assign({ className: styles$1.table, role: "table", "aria-label": "data table" }, { children: [jsxRuntime.jsx(TableHead$1, { children: jsxRuntime.jsx(TableRow$1, { children: header.map(function (heading) {
                                ...
                                return (jsxRuntime.jsxs(TableCell$1, __assign({ sortDirection: orderBy == heading.id ? order : false, align: alignment }, { children: [props.sortable &&
                                            jsxRuntime.jsxs(TableSortLabel$1, __assign({ active: orderBy == heading.id, direction: orderBy === heading.id ? order : 'desc', onClick: function () { return handleRequestSort(heading.id); } }, { children: [heading.value, orderBy == heading.id ? (jsxRuntime.jsx("span", __assign({ className: styles$1.screenreaderVisible }, { children: order === 'desc' ? 'sorted descending' : 'sorted ascending' }), void 0)) : null] }), void 0), !props.sortable && heading.value] }), heading.id));
                            }) }, void 0) }, void 0),
...
var Search = function (props) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: styles.container, role: "search" }, { children: [jsxRuntime.jsx(TextField$1, { variant: variant, fullWidth: true, id: id, onChange: function (e) { return onSearchChange(e); }, label: label }, void 0),
            props.loading && jsxRuntime.jsx("div", __assign({ className: styles.loadingContainer }, { children: jsxRuntime.jsx(Loading, { colour: loadingColour }, void 0) }), void 0)] }), void 0));
};
